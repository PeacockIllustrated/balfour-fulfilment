...
export async function GET(
  ...
  try {
      ...
      return new NextResponse(
        ...
        <body style="font-family:Arial,sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;background:#f8faf9">
          <div style="text-align:center;padding:40px;background:white;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.1);max-width:400px">
            ...
            <a href="${siteUrl}/admin" style="display:inline-block;margin-top:20px;background:#005d99;color:white;padding:10px 24px;border-radius:8px;text-decoration:none;font-size:14px;font-weight:bold">View in Admin Dashboard</a>
          </div>
        </body></html>`,
    ...
    return new NextResponse(
      ...
      <body style="font-family:Arial,sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;background:#f8faf9">
        <div style="text-align:center;padding:40px;background:white;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.1);max-width:400px">
          <div style="width:48px;height:48px;background:#005d99;border-radius:50%;margin:0 auto 16px;display:flex;align-items:center;justify-content:center">
            <span style="color:white;font-size:24px">&#10003;</span>
          </div>
          <h1 style="color:#002b49;font-size:20px;margin:0 0 8px">PO Request Sent</h1>
