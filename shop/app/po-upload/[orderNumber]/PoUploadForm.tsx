  ...
  async function handleUpload() {
    ...
    try {
      ...
      const res = await fetch(
        `/api/orders/${orderNumber}/upload-po?t=${token}`,
  ...
  if (done) {
    return (
      <div className="text-center">
        ...
        <h2 className="text-xl font-bold text-[#002b49] mb-2">PO Document Uploaded</h2>
        <p className="text-gray-500 text-sm">
          Your purchase order for <strong>{orderNumber}</strong> has been received.
        </p>
      </div>
    );
  }
      ...
      >
        ...
        {file ? (
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">Click to select your PO document</p>
